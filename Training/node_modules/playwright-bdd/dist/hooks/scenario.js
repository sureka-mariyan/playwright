...
exports.getScenarioHooksFixtures = exports.runScenarioHooks = exports.hasScenarioHooksWithWorldFromCucumber = exports.scenarioHookFactory = void 0;
 ...
 */
function scenarioHookFactory(type, { useWorldFixture = false } = {}) {
    return (...args) => {
        addHook({
            type,
...
function hasScenarioHooksWithWorldFromCucumber() {
    return scenarioHooks.filter((hook) => !hook.useWorldFixture).length > 0;
}
exports.hasScenarioHooksWithWorldFromCucumber = hasScenarioHooksWithWorldFromCucumber;
