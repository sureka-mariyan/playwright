...
class TestFile {
    ...
    getTechnicalSection() {
        ...
        return this.formatter.technicalSection(this.testMetaBuilder, this.featureUri, [
            ...
            ...((0, scenario_1.hasScenarioHooksWithWorldFromCucumber)() || this.hasStepsDefinedViaCucumber()
    ...
    getStepFixtureNames(stepDefinition) {
        const stepConfig = (0, stepConfig_1.getStepConfig)(stepDefinition);
        if ((0, stepConfig_1.isDefinedViaCucumber)(stepConfig)) {
        ...
        if ((0, stepConfig_1.isUsingWorldFixture)(stepConfig))
            return [];
        if (stepConfig?.fn) {
            return (0, fixtures_1.extractFixtureNames)(stepConfig.fn);
        }
        return [];
    }
    ...
    hasStepsDefinedViaCucumber() {
        return [...this.usedStepDefinitions].some((stepDefinition) => {
            return (0, stepConfig_1.isDefinedViaCucumber)((0, stepConfig_1.getStepConfig)(stepDefinition));
        });
    }
    getWorldFixtureName() {
        const worldFixtureNames = new Set();
        this.usedStepDefinitions.forEach((stepDefinition) => {
            const worldFixture = (0, stepConfig_1.getStepConfig)(stepDefinition)?.worldFixture;
            if (worldFixture)
